...
export const de = {
  ...
  exportDialog: {
    ...
    serviceHint: "Steht so in der Vorlage; für den nächsten Export gemerkt.",
    location: "Ort",
    locationPlaceholder: "z. B. Waldfrieden",
    serviceTime: "Uhrzeit",
    serviceTimePlaceholder: "z. B. 11:00 Uhr",
    layout: "Darstellung",
    ...
    speakerStyle: "Namen stehen",
    speakerStyleInline: "Vor dem Absatz",
    speakerStyleLine: "In eigener Zeile",
    blankLines: "Leerzeile zwischen Absätzen",
    musicStyle: "Musik erscheint als",
    musicStyleMarker: "Markierung, z. B. [Gemeindegesang]",
    musicStyleCue: "Zeile zum Überschreiben, z. B. Lied Nr. 71",
  ...
  templates: {
    ...
    fields: {
      ...
      ort: "Ort des Gottesdienstes, im Export-Dialog eingetragen",
      zeit: "Uhrzeit, im Export-Dialog eingetragen",
      datum: "Datum des Gottesdienstes, z. B. 18.08.2023",
      langesdatum: "Datum ausgeschrieben, z. B. 18. August 2023",
